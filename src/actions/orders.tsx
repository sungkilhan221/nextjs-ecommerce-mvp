...
export async function createPaymentIntent(
  ...
  const discountCode =
    discountCodeId == null
      ...
      : await db.discountCode.findUnique({
          where: { id: discountCodeId, ...useableDiscountCodeWhere(productId) },
        });
  ...
  if (existingOrder != null) {
    return {
      error:
        "Your have already purchased this product. Try downloading it from the My Orders page",
    };
  }
